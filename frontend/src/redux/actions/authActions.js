...
export const registerUser = (formData) => async (dispatch) => {
  ...
  try {
    const res = await axios.post('https://cricslot-api.onrender.com/api/auth/register', formData);
...
export const loginUser = (formData) => async (dispatch) => {
  ...
  try {
    const res = await axios.post('https://cricslot-api.onrender.com/api/auth/login', formData);
