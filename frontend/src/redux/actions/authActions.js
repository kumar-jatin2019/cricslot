...
export const registerUser = (formData) => async (dispatch) => {
  ...
  try {
    const res = await axios.post('https://cricslot-i55o.vercel.app/api/auth/register', formData);
...
export const loginUser = (formData) => async (dispatch) => {
  ...
  try {
    const res = await axios.post('https://cricslot-i55o.vercel.app/api/auth/login', formData);
